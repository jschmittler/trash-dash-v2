...
const UnavailableRuntimeStateServiceType := preload("res://src/core/services/unavailable_runtime_state_service.gd")
const UnavailableSaveSettingsServiceType := preload("res://src/core/services/unavailable_save_settings_service.gd")
const UnavailableSceneTransitionServiceType := preload("res://src/core/services/unavailable_scene_transition_service.gd")
