# Trashy Powered - Approved Sprite Atlas

**Status:** Approved for Phase 01 main-character use.

**Canonical asset:** `atlases/trashy-powered-approved.png`

**Dimensions:** `1024 x 1536` px, RGBA.

## What this atlas contains

Approved powered-up Trashy atlas. Heavier armored silhouette, orange scarf, expanded locomotion and recovery poses, victory poses, and glide sequence.
