...
Source provenance, prompts, source-master provenance, processing report, and static QA are recorded beside the candidates. The canonical references remain the five cataloged `approved-source` background images in `docs/design/trash-dash/library/environments/backgrounds/level-02/`.
